...
var direct = 'DIRECT;';
var public_http_proxy = "PROXY pfq.testerhome.com:10081;";
var oneapm_http_proxy = "PROXY 10.128.6.46:8080;";
var proxy = "SOCKS 127.0.0.1:1080; SOCKS5 fq.testerhome.com:1080; DIRECT;";
var oneapm_list=[];
...
function FindProxyForURL(url, host) {
	...
	for (;;) {
		...
		if (pos <= 0) {
			if (shExpMatch(url, "http:*oneapm.me*"))
			{
				return oneapm_http_proxy;
			}
			return direct;
		}
